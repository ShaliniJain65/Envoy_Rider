      ...
      <div class="content">
        <div class="content-bar">
          ...
          <ul class="breadcrumb breadcrumb-angle">
            ...
            <li><a href="#">Manage Trasnporter</a></li>
	              ...
	              <!-- /panel-basicform -->
	                <div class="panel adjust-panel panel-white" style="padding: 20px;margin-top: 15px">
	                	<div class="panel-heading">
	                		<h3 class="text-left"><i class="fa fa-pencil-square"></i> Update <span class="text-bold">Transporter</span></h3>
	                	</div>
	     	           <div class="panel-body">
		                	<form action="<%= request.getContextPath() %>/Controller1" method="post">
	                			<input type="hidden" name="actionCode" value="update_transporter_by_contactno">
	                		<div class="col-sm-8">
								<input type="string" class="form-control" name="courierid" id="courierid" placeholder="Insert Courier Id here" required>
	                		</div>
	                		<div class="col-sm-4">
	                		...
	                		<% 
	                	try{	
	                		List<AddNewTransporter> transporter_list =(List<AddNewTransporter>) request.getAttribute("transporterDetail");
	                		AddNewTransporter addNewTransporter = new AddNewTransporter();
	                		if(!transporter_list.isEmpty() && transporter_list != null)
	                		{
	                			Iterator i = transporter_list.iterator();
	                			while(i.hasNext())
	                			{
	                				addNewTransporter = (AddNewTransporter) i.next();
	                		%>
							...
							<div class="row">
	                          <div class="col-md-6 mb-2x">
		                        ...
		                        <div class="col-md-6 mb-2x">
			                          ...
			                          <input class="form-control" id="input" placeholder="enter  name" name="companyname" value="<%= addNewTransporter.getCompanyname() %>">
		                        </div>
                       	 	</div>   
		                 	<div class="row">
			                	<div class="col-md-6 mb-2x">
			                      <label for="input">Contact No.</label>
			                      <input class="form-control" id="input" placeholder="Enter contact number" name="contactno" value="<%= addNewTransporter.getContactno()%>">
			                  	</div>
			                  	<div class="col-md-6 mb-2x">
			                      <label for="inputTextarea">Address</label>
			                      <textarea rows="3" class="form-control" id="inputTextarea" name="address" placeholder="Enter your address"><%= addNewTransporter.getAddress() %>"</textarea>
			                  	</div>
	                  	  	</div>
